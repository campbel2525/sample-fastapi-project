  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        FullRepositoryId = "${var.github_owner}/${var.github_target_repository}"
...
resource "github_repository_webhook" "codepipeline" {
  repository = var.github_target_repository
