...
def get_user_by_access_token(
    ...
    auth_user = (
        ...
        .filter(models.AdminUser.id == payload["id"])
...
def create_access_token(auth_user: models.AdminUser) -> str:
    """
    access_tokenを生成する
    """
...
def create_refresh_token(auth_user: models.AdminUser) -> str:
    """
    refresh_tokenを生成する
    """
    return __create_jwt_token(
